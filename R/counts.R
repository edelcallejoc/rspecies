...
#'     then it calculates \code{crossprod(x.mat[,target], ones)}. \strong{Nx} an integer vector.
...
#'     it calculates \code{crossprod(x.mat[,-target], ones)}. \strong{Ncx} an integer matrix. If
...
#'     \code{crossprod(x.mat[,target], x.mat[,-target])}.
#'
...
#'     \code{bioclim}. If \code{target} is different from \code{NULL} then the matrices
